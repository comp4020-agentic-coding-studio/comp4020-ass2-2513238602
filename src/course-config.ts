...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP3745",
  title: "League of Legends Champion Mastery",
  session: "Season 2027",
  year: 2027,
  level: 3,
  ...
  endDate: "2027-05-28",
  description:
    "A twelve-week practice studio where League of Legends players turn one champion into a complete competitive system: every lane matchup tested, every counter explained, and every lead carried into the whole map.",
  tags: ["League of Legends", "champion mastery", "esports training"],
